...
public class NewForestPony extends Breed {

	@Override
	public String getName() {
		return "New Forest Pony";
	}
	...
	public List<Color> getSupportedColors() {
		return new ArrayList<Color>(Arrays.asList(Color.BROWN, Color.DARK_BROWN, Color.GRAY, Color.CHESTNUT));
	}
